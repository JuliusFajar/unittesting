import 'package:gd13_unittesting_1291/model/login_model.dart';
...
class LoginRepository {
  ...
  static Future<LoginModel?> login(
    ...
    try {
      ...
      if (apiResult.statusCode == 200) {
        return LoginModel.formRawJson(apiResult.body);
      } else {
  ...
  static Future<LoginModel?> logintesting({
    ...
    try {
      ...
      if (apiResult.statusCode == 200) {
        final result = LoginModel.formRawJson(apiResult.body);
        return result;
      } else {
        throw Exception('Failed to Login');
      }
